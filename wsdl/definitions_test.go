...
func TestUnmarshalGlobalWeather(t *testing.T) {
	...
	expected := wsdl.Definitions{
		...
		Messages: []wsdl.Message{
			...
			{
				Name:  "GetCitiesByCountrySoapIn",
				Parts: []wsdl.Part{{Name: "parameters", Element: "tns:GetCitiesByCountry"}},
			},
			{
				Name:  "GetCitiesByCountrySoapOut",
				Parts: []wsdl.Part{{Name: "parameters", Element: "tns:GetCitiesByCountryResponse"}},
			},
			{
				Name:  "GetWeatherHttpGetIn",
				Parts: []wsdl.Part{{Name: "CityName", Type: "s:string"}, {Name: "CountryName", Type: "s:string"}},
			},
				...
				Operations: []wsdl.Operation{
					{
						...
						Input:         &wsdl.Input{Message: "tns:GetWeatherSoapIn"},
						Output:        &wsdl.Output{Message: "tns:GetWeatherSoapOut"},
					},
					{
						Name:          "GetCitiesByCountry",
						Documentation: "Get all major\n                cities by country name(full / part).",
						Input:         &wsdl.Input{Message: "tns:GetCitiesByCountrySoapIn"},
						Output:        &wsdl.Output{Message: "tns:GetCitiesByCountrySoapOut"},
					},
				},
			},
			{
				...
				Operations: []wsdl.Operation{
					{
						Name:          "GetWeather",
						Documentation: "\n                Get weather report for all major cities around the world.\n            ",
						Input:         &wsdl.Input{Message: "tns:GetWeatherHttpGetIn"},
						Output:        &wsdl.Output{Message: "tns:GetWeatherHttpGetOut"},
					},
					{
						Name:          "GetCitiesByCountry",
						Documentation: "Get all major\n                cities by country name(full / part).",
						Input:         &wsdl.Input{Message: "tns:GetCitiesByCountryHttpGetIn"},
						Output:        &wsdl.Output{Message: "tns:GetCitiesByCountryHttpGetOut"},
					},
				},
			},
			{
				...
				Operations: []wsdl.Operation{
					{
						Name:          "GetWeather",
						Documentation: "\n                Get weather report for all major cities around the world.\n            ",
						Input:         &wsdl.Input{Message: "tns:GetWeatherHttpPostIn"},
						Output:        &wsdl.Output{Message: "tns:GetWeatherHttpPostOut"},
					},
					{
						Name:          "GetCitiesByCountry",
						Documentation: "Get all major\n                cities by country name(full / part).",
						Input:         &wsdl.Input{Message: "tns:GetCitiesByCountryHttpPostIn"},
						Output:        &wsdl.Output{Message: "tns:GetCitiesByCountryHttpPostOut"},
					},
				},
			},
		},
		Binding: []wsdl.Binding{
			{
				...
				BindingOperations: []wsdl.BindingOperation{
					{
						Name: "GetWeather",
						SOAP11Operation: &wsdl.SOAPOperation{
			...
			},
			{
				...
				BindingOperations: []wsdl.BindingOperation{
					{
						Name: "GetWeather",
						SOAP12Operation: &wsdl.SOAPOperation{
							SOAPAction: "http://www.webserviceX.NET/GetWeather",
							Style:      "document",
						},
				...
				BindingOperations: []wsdl.BindingOperation{
					{
						Name:          "GetWeather",
						HTTPOperation: &wsdl.HTTPOperation{Location: "/GetWeather"},
						Input: &wsdl.BindingBody{
							MIMEContent: []*wsdl.MIMEContent{{Type: "application/x-www-form-urlencoded"}},
						},
						Output: &wsdl.BindingBody{MIMEXML: &wsdl.MIMEXML{Part: "Body"}},
					},
					{
				...
				Ports: []wsdl.Port{
					{
						...
						SOAP11Address: &wsdl.SOAPAddress{Location: "http://www.webservicex.com/globalweather.asmx"},
					},
					{
						Name:          "GlobalWeatherSoap12",
						Binding:       "tns:GlobalWeatherSoap12",
						SOAP12Address: &wsdl.SOAPAddress{Location: "http://www.webservicex.com/globalweather.asmx"},
					},
					{
						Name:        "GlobalWeatherHttpGet",
						Binding:     "tns:GlobalWeatherHttpGet",
						HTTPAddress: &wsdl.HTTPAddress{Location: "http://www.webservicex.com/globalweather.asmx"},
					},
					{
						Name:        "GlobalWeatherHttpPost",
